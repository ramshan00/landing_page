  ...
  return (
    <section className="w-full min-h-[85vh] flex flex-col justify-center items-center py-15 px-6 md:px-16 relative text-white gap-2">
      ...
      <div className="overflow-hidden text-center">
        <motion.p
          className="text-4xl sm:text-6xl md:text-7xl mont font-medium hover:scale-95 transition-all duration-300 uppercase  "
          initial={{ y: "100%" }}
          animate={{ y: 0 }}
      ...
      >
        <p >We are not just coders. We are architects of the future.
</p>
        <p > 
  Obsessed with precision. Allergic to mediocrity.
        </p>
      </motion.div>
